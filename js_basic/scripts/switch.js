...
// switch(order){
//     case '딸기':alert('딸기는 1000원');
//     break;
//     case '수박':console.log('수박은 10000원');
//     break;
//     case '오렌지':console.log('오렌지는 5000원');
//     break;
//     case '망고':console.log('망고는 7000원');
//     break;
//     default:console.log('판매하지 않는 상품입니다.')
// }
//----------------예제 3 휴대폰 전화 단축키 알고리즘
// 1번 입력 시 엄마
// 2번 입력 시 아빠
// 3번 입력 시 동생
// 해당 단축키가 없습니다.
...
switch(callNumber){
    case 1:alert('엄마에게 전화중');
    break;
    case 2:alert('아빠에게 전화중');
    break;
    case 3:alert('동생에게 전화중');
    break;
